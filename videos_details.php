...
//var_dump($_GET['category']);
    $url4 = 'https://criknowapp.herokuapp.com/get_video_detail/';
    $options4 = array(
      'http' => array(
        'header'  => array(
                        'PK:'.$_GET['cat'],
...
session_start();
//var_dump($_GET['topic']);
    $url3 = 'https://criknowapp.herokuapp.com/get_video_detail/';
    $options3 = array(
      'http' => array(
        'header'  => array(
                        'PK:'.$_GET['top'],
...
?>
      ...
      <div class="row">
        <div class="col-sm-12">
          <div class="sub-card">
            <div class="card-body">
              ...
              <div style="border-bottom: 1px solid #e3e6e3;padding: 0px 0px 15px 0px;margin-bottom: 15px;">
        ...
        <?php  $site=$arr4['url'][0]['video_links'][0]['link'];
        preg_match_all("/(?=v\=([^\s]+))/", $site, $matches);
        $result = implode(" ", $matches[1]);
        $urll='https://www.youtube.com/embed/';
        $ur=$urll.$result;
        //var_dump($ur);
        ?>
        
        <iframe width="630" height="380" class="video"
src="<?php echo $ur;?>">
</iframe>
              ...
              <h1 class="heading"><?php echo $_GET['pk'];?></h1>
               <time class="time"><?php echo $arr4['url'][0]['video_links'][0]
               ['created']; ?></time>
              ...
              <?php  $site=$arr3['url'][0]['video_links'][0]['link'];
        preg_match_all("/(?=v\=([^\s]+))/", $site, $matches);
        $result = implode(" ", $matches[1]);
        $urll='https://www.youtube.com/embed/';
        $ur=$urll.$result;
...
src="<?php echo $ur;?>">
              ...
              <h1 class="heading"><?php echo $_GET['pk'];?></h1>
              <time class="time"><?php echo $arr3['url'][0]['video_links'][0]
               ['created']; ?></time>
            ...
            <?php if(isset($_GET['cat'])){ ?>
            <span class="category"><?php echo $arr4['video']['video_details']['category'];?></span>
          <?php }else{ ?>
            <span class="topic"><?php echo $arr3['video']['video_details']['topic'];?></span>
            <?php } ?>
          ...
          <div class="col-sm-3">
            <h4 class="suggested">SUGGESTED VIDEOS</h4>
            
            <?php   for($xre=1;$xre>=0;$xre--){ 
                  if(count($arr4['url']) > 0){ ?>

                <a href="./videos_details.php?pk=<?php echo $arr4['url'][$xre]
                ['video_links'][0]['title'];?>&cat=<?php echo $arr4['url'][$xre]
                ['video_links'][0]['pk'];?>" title="<?php echo $arr4['url']
                [$xre]['video_links'][0]['title']; ?>">
                <img class="image" src="<?php echo $arr4['url']
                [$xre]['video_links'][0]['url']; ?>"></img></a></a>

                <a href="./videos_details.php" title="<?php echo $arr4['url']
                [$xre]['video_links'][0]['title']; ?>"><img class="play-image" src="images/play.png"></img></a>

                <a href="./videos_details.php?pk=<?php echo $arr4['url'][$xre]
                ['video_links'][0]['title'];?>&cat=<?php echo $arr4['url'][$xre]
                ['video_links'][0]['pk'];?>" title="<?php echo $arr4['url']
                [$xre]['video_links'][0]['title']; ?>"><h4 class="title"><?php echo $arr4['url']
                [$xre]['video_links'][0]['title']; ?></h4></a>

                <time class="time1"><?php echo $arr4['url'][$xre]['video_links'][0]
                  ['created']; ?></time><br><br>
