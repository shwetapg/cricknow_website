...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="css/style_latest_all_videos.css">
  </head>
...
session_start();
   ...
   /* echo $output4;*/
    $json = file_get_contents($url5,0,null,null); 
    $arr5 = json_decode($json, true); 
        ...
        <div class="col-sm-12">
          <div class="sub-card">
            <div class="card-body">
                ...
                <div class="row">
                <div class="col-sm-9">
                <div style="border-right: 1px solid #e3e6e3;margin-right: 12%;">  
                <h1 class="heading">Latest Cricket Videos</h1>
       ...
       <div class="row" style="border-bottom: 1px solid #e3e6e3;padding: 0px 0px 16px 0px;margin-bottom: 30px;width: 856px;">
          ...
          <?php } ?></div>
            ...
            <?php } ?>
              ...
              <?php }} ?>
              <a href="./news.php" title="Click to view more News"><button class="button">More News</button></a>
            </div>
          </div>
