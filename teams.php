...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="css/style_teams.css">
  </head>
        ...
        <div class="col-sm-12">
          <div class="sub-card">
            <div class="card-body">
            	...
            	<nav class="lower">
            		<div id="myDIV">
                    <a href="#" class="main">Current Matches</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <a href="#" class="main">Current & Future Series</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <a href="#" class="main">Matches By Day</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <a href="teams.php" class="main active">Teams</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <a href="#" class="main">Series Archive</a>
                  </div>
                   </nav>
                </div>
                	 ...
                	 <div style="border-bottom: 1px solid #e3e6e3;padding: 0px 0px 20px 0px;">
                	 <nav class="teamnav">
                	 	
                     <a href="#" class="active1" style="margin-left: 0px;">International</a>
                    <a href="#" >Domestic</a>
                    <a href="#" >League</a>
                    <a href="#" >Women</a>
                  	...
                  	<div class="row">
                  		<div class="col-sm-9">
                  			...
                  			<div class="row" style="border-bottom: 1px solid #e3e6e3;padding: 0px 0px 16px 0px;width: 102%;">
                  				<div class="col-sm-6">
                  					
                  					<div class="teams-flags">
                  					<a href="./team_details.php"><img class="flag-image" src="images/india.png"></img></a>
                  					<a href="./team_details.php" class="head">India</a>
                  				</div>
                  				</div>
                  				<div class="col-sm-6">
                  					<div class="teams-flags">
                  					<a href="./team_details.php"><img class="flag-image" src="images/australia.jpg" style="margin-left: 15%;"></img></a>
                  					<a href="./team_details.php" class="head">Australia</a>
